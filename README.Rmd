...
and prioritisation of species with high medicinal potential. The new methods implemented 
in the package propose solutions to some of the inherent limitations 
of using 'hot nodes' in bioprospecting, extend the 'hot node' approach to the 
concept of 'hot trees' and offer new ways of prioritising potential new medicinal
species. These new functionalities are presented and discussed in Zecca et al. (2025).
...
- compute the (relative) probability of being a medicinal species for all the taxa 
  present in the provided (hot) tree(s);
...
* Zecca, G., Toini, E., Labra, M, Grassi, F. (2025) Accelerating the identification and the prioritisation of new plants with medicinal potential: the  pm4mp R package.
